...
import com.github.nalukit.nalu.plugin.gwt.client.DefaultGWTClientLogger;
  ...
  private ClassName getLogger() {
    switch (this.naluGeneraterParms.getWidgetLibrary()) {
      case DOMINO_UI:
        // TODO Elemento
        //      case ELEMENTO:
        return ClassName.get(DefaultElemental2ClientLogger.class);
      case GWT:
      case GXT:
        return ClassName.get(DefaultGWTClientLogger.class);
    }
    return null;
  }
